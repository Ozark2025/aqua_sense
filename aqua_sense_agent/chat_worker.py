...
# ✅ LangChain 1.x Runnable instead of LLMChain
...
#     # ✅ 4. LLM Response (Runnable invoke)
#     response = chat_chain.invoke({"chat": augmented_chat}).content
...
def chat_work(chat_str: str, history: dict = None, agent_key: str = "knowledge-mentor"):
    ...
    # ✅✅✅ FIXED RAG CALL (THIS WAS THE BUG)
    docs = retriever.invoke(chat_str)
