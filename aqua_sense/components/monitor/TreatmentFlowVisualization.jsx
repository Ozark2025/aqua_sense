...
const treatmentStages = [
  { 
    ...
    wastage: {
      irrigation: [
        { type: "Screenings & Grit", description: "Solid debris", waterLoss: "0.08%" },
        { type: "Filter Backwash", description: "Cleaning cycles", waterLoss: "3.5%" },
        { type: "Settling Tank Sludge", description: "Primary sludge", waterLoss: "0.8%" }
      ],
      freshwater: [
        { type: "Screenings & Grit", description: "Solid debris", waterLoss: "0.05%" },
        { type: "Filter Backwash", description: "Cleaning cycles", waterLoss: "4.2%" },
        { type: "Settling Tank Sludge", description: "Primary sludge", waterLoss: "1.1%" }
      ],
      cooling: [
        { type: "Screenings & Grit", description: "Solid debris", waterLoss: "0.06%" },
        { type: "Filter Backwash", description: "Cleaning cycles", waterLoss: "2.8%" },
        { type: "Settling Tank Sludge", description: "Primary sludge", waterLoss: "0.6%" }
      ]
    },
    efficiency: {
      irrigation: "86%",
  ...
  { 
    ...
    wastage: {
      irrigation: [
        { type: "Waste Activated Sludge (WAS)", description: "Extra biomass", waterLoss: "1.2%" },
        { type: "Foam & Scum", description: "Biological froth", waterLoss: "0.08%" },
        { type: "Evaporation", description: "From aeration tanks", waterLoss: "0.25%" },
        { type: "Sampling & drainage", description: "Testing losses", waterLoss: "0.05%" },
        { type: "Clarifier overflow loss", description: "Process loss", waterLoss: "0.18%" }
      ],
      freshwater: [
        { type: "Waste Activated Sludge (WAS)", description: "Extra biomass", waterLoss: "1.5%" },
        { type: "Foam & Scum", description: "Biological froth", waterLoss: "0.09%" },
        { type: "Evaporation", description: "From aeration tanks", waterLoss: "0.22%" },
        { type: "Sampling & drainage", description: "Testing losses", waterLoss: "0.06%" },
        { type: "Clarifier overflow loss", description: "Process loss", waterLoss: "0.21%" }
      ],
      cooling: [
        { type: "Waste Activated Sludge (WAS)", description: "Extra biomass", waterLoss: "0.9%" },
        { type: "Foam & Scum", description: "Biological froth", waterLoss: "0.07%" },
        { type: "Evaporation", description: "From aeration tanks", waterLoss: "0.32%" },
        { type: "Sampling & drainage", description: "Testing losses", waterLoss: "0.04%" },
        { type: "Clarifier overflow loss", description: "Process loss", waterLoss: "0.15%" }
      ]
    },
    efficiency: {
      irrigation: "95%",
  ...
  { 
    ...
    wastage: {
      irrigation: [
        { type: "Membrane/Filter Backwash", description: "RO/UF cleaning", waterLoss: "8.5%" },
        { type: "UV System Flushing", description: "Maintenance flush", waterLoss: "0.08%" },
        { type: "Chemical Dosing Residue", description: "Treatment byproduct", waterLoss: "0.09%" },
        { type: "Final Filter Rinse", description: "Polishing filter", waterLoss: "0.7%" }
      ],
      freshwater: [
        { type: "Membrane/Filter Backwash", description: "RO/UF cleaning", waterLoss: "12.5%" },
        { type: "UV System Flushing", description: "Maintenance flush", waterLoss: "0.09%" },
        { type: "Chemical Dosing Residue", description: "Treatment byproduct", waterLoss: "0.08%" },
        { type: "Final Filter Rinse", description: "Polishing filter", waterLoss: "0.9%" }
      ],
      cooling: [
        { type: "Membrane/Filter Backwash", description: "RO/UF cleaning", waterLoss: "6.2%" },
        { type: "UV System Flushing", description: "Maintenance flush", waterLoss: "0.07%" },
        { type: "Chemical Dosing Residue", description: "Treatment byproduct", waterLoss: "0.06%" },
        { type: "Final Filter Rinse", description: "Polishing filter", waterLoss: "0.5%" }
      ]
    },
    efficiency: {
      irrigation: "97.5%",
                ...
                <div className={`glassmorphism-strong rounded-2xl p-6 border-2 relative ${isActive ? "shadow-2xl" : isPassed ? "" : ""}`} style={{ borderColor: isFault ? "rgba(239,68,68,0.6)" : undefined }}>
                  ...
                  {(isActive || isPassed) && (
                    <>
                      ...
                      {/* Wastage Information */}
                      {stage.wastage && stage.wastage[selectedCategory] && stage.wastage[selectedCategory].length > 0 && (
                        <div style={{ marginBottom: 16, padding: 12, background: "rgba(148, 163, 184, 0.08)", borderRadius: 8 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                            <div style={{ fontSize: 14, fontWeight: 700, color: "#1e293b" }}>💧 Stage Wastage</div>
                            <div style={{ marginLeft: "auto", fontSize: 12, fontWeight: 700, color: "#059669", padding: "2px 8px", background: "rgba(16, 185, 129, 0.1)", borderRadius: 4 }}>
                              Efficiency: {stage.efficiency[selectedCategory]}
                            </div>
                          </div>
                          <div style={{ display: "grid", gap: 8 }}>
                            {stage.wastage[selectedCategory].map((waste, wIdx) => (
                              <div key={wIdx} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 10px", background: "rgba(255, 255, 255, 0.5)", borderRadius: 6, fontSize: 12 }}>
                                <div style={{ flex: 1 }}>
                                  <div style={{ fontWeight: 700, color: "#0f172a" }}>{waste.type}</div>
                                  <div style={{ color: "#64748b", fontSize: 11 }}>{waste.description}</div>
        ...
        {currentStage >= treatmentStages.length && (
          <motion.div ref={completeRef} initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="mt-8 glassmorphism-strong rounded-3xl p-8 border-2">
            ...
            <div style={{ marginBottom: 20, padding: 16, background: "linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(5, 150, 105, 0.15))", borderRadius: 12, border: "2px solid rgba(16, 185, 129, 0.3)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 12 }}>
                {treatmentStages.map((stage, idx) => (
                  <div key={`eff-${idx}`} style={{ padding: 12, background: "rgba(255, 255, 255, 0.6)", borderRadius: 8, textAlign: "center" }}>
                    <div style={{ fontSize: 24, marginBottom: 4 }}>{stage.icon}</div>
                    <div style={{ fontSize: 11, fontWeight: 600, color: "#64748b", marginBottom: 4 }}>{stage.name}</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: "#059669" }}>{stage.efficiency[selectedCategory]}</div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ padding: 16, background: "rgba(16, 185, 129, 0.2)", borderRadius: 10, textAlign: "center" }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#065f46", marginBottom: 6 }}>COMBINED SYSTEM EFFICIENCY</div>
                <div style={{ fontSize: 36, fontWeight: 900, color: "#047857", letterSpacing: "-0.02em" }}>
                  {selectedCategory === "irrigation" ? "89.2%" : selectedCategory === "freshwater" ? "92.1%" : "87.8%"}
                </div>
                <div style={{ fontSize: 12, color: "#059669", marginTop: 4 }}>Total water recovery and treatment effectiveness</div>
              </div>
            </div>
