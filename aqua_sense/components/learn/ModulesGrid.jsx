...
const modules = [
  {
    ...
    description: 'How water evaporates, condenses, and returns to Earth — the foundation of all water systems.',
    icon: Globe,
    color: 'from-blue-400 to-blue-600',
    duration: '3:34',
    level: 'Beginner',
    youtube: 'https://www.youtube.com/watch?v=RwtO04EXgUE',
    illustration: 'https://img.youtube.com/vi/RwtO04EXgUE/hqdefault.jpg'
  },
  {
    id: 'water_quality',
    title: 'What Makes Water Safe or Unsafe?',
    description: 'TDS, turbidity, pH, hardness and other contaminants — how they are measured and why they matter.',
    icon: Droplets,
    color: 'from-cyan-500 to-blue-500',
    duration: '12:45',
    level: 'Beginner',
    youtube: 'https://www.youtube.com/watch?v=A_Em0sLU5iA',
    illustration: 'https://img.youtube.com/vi/A_Em0sLU5iA/hqdefault.jpg'
  },
  {
    id: 'primary_treatment',
    title: 'How Primary Wastewater Treatment Works',
    description: 'Screening, grit removal and sedimentation — the physical steps that remove large solids.',
    icon: BookOpen,
    color: 'from-teal-500 to-green-500',
    duration: '9:20',
    level: 'Beginner',
    youtube: 'https://www.youtube.com/watch?v=uME-5LP4KJo',
    illustration: 'https://img.youtube.com/vi/uME-5LP4KJo/hqdefault.jpg'
  },
  {
    id: 'secondary_treatment',
    title: 'Biological Treatment Explained (Activated Sludge)',
    description: 'How microbes break down organic matter in aeration tanks and clarifiers (activated sludge).',
    icon: Microscope,
    color: 'from-green-500 to-lime-500',
    duration: '11:30',
    level: 'Intermediate',
    youtube: 'https://www.youtube.com/watch?v=EZ8P5Dp1j2g',
    illustration: 'https://img.youtube.com/vi/EZ8P5Dp1j2g/hqdefault.jpg'
  },
  {
    id: 'tertiary_treatment',
    title: 'Tertiary & Advanced Treatment',
    description: 'Disinfection, filtration (sand/carbon), and polishing steps used to meet reuse/discharge standards.',
    icon: Cpu,
    color: 'from-indigo-500 to-purple-600',
    duration: '12:00',
    level: 'Intermediate',
    youtube: 'https://www.youtube.com/watch?v=Lbyvqy8mqjY',
    illustration: 'https://img.youtube.com/vi/Lbyvqy8mqjY/hqdefault.jpg'
  },
  {
    id: 'membrane_processes',
    title: 'Basics of UF, NF and RO Membranes',
    description: 'How membrane filtration (UF/NF/RO) works and where each is used in water & wastewater systems.',
    icon: TrendingUp,
    color: 'from-blue-700 to-cyan-700',
    duration: '14:22',
    level: 'Advanced',
    youtube: 'https://www.youtube.com/watch?v=xWEOFhzV6s0',
    illustration: 'https://img.youtube.com/vi/xWEOFhzV6s0/hqdefault.jpg'
  },
  {
    id: 'disinfection',
    title: 'Disinfection: Chlorine, UV & Ozone',
    description: 'How pathogens are inactivated with chlorine, UV light and ozone — pros/cons of each method.',
    icon: Sparkles,
    color: 'from-yellow-500 to-orange-500',
    duration: '12:42',
    level: 'Beginner',
    youtube: 'https://www.youtube.com/watch?v=i9VC2ejYkYs',
    illustration: 'https://img.youtube.com/vi/i9VC2ejYkYs/hqdefault.jpg'
  },
  {
    id: 'industrial_reuse',
    title: 'Industrial Water Reuse Explained',
    description: 'How treated wastewater is reused for cooling, boilers, cleaning, and other industrial needs.',
    icon: Factory,
    color: 'from-gray-600 to-blue-600',
    duration: '8:50',
    level: 'Intermediate',
    youtube: 'https://www.youtube.com/watch?v=7-4f63tEJRI',
    illustration: 'https://img.youtube.com/vi/7-4f63tEJRI/hqdefault.jpg'
  },
  {
    id: 'india_crisis',
    title: 'India’s Water Crisis & Solutions',
    description: 'Overview of water scarcity challenges in India and practical reuse & conservation solutions.',
    icon: Globe,
    color: 'from-red-500 to-orange-500',
    duration: '10:20',
    level: 'Beginner',
    youtube: 'https://www.youtube.com/watch?v=6R8hwhhMTZI',
    illustration: 'https://img.youtube.com/vi/6R8hwhhMTZI/hqdefault.jpg'
  },
  {
    id: 'sustainability',
    title: 'Sustainable Water Practices for Everyone',
    description: 'Everyday water-saving habits and community practices that reduce demand and pollution.',
    icon: GraduationCap,
    color: 'from-green-500 to-teal-600',
    duration: '4:05',
    level: 'Beginner',
    youtube: 'https://www.youtube.com/watch?v=Fvkzjt3b-dU',
    illustration: 'https://img.youtube.com/vi/Fvkzjt3b-dU/hqdefault.jpg'
  }
];
...
export default function ModulesGrid() {
  ...
  // Parallax transforms for header/background
  const headerY = useTransform(scrollYProgress, [0, 0.3], [100, 0]);
  const headerOpacity = useTransform(scrollYProgress, [0, 0.3], [0, 1]);
  const backgroundY = useTransform(scrollYProgress, [0, 1], [0, 200]);

  // IMPORTANT: create droplet transforms in a stable, deterministic order (hooks must be called in same order each render)
  const DROPLET_COUNT = 15;
  const dropletTransforms = Array.from({ length: DROPLET_COUNT }, (_, i) =>
    useTransform(scrollYProgress, [0, 1], [0, (i - 7) * 80])
  );
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-shakespeare-300/30">
                      ...
                      <motion.button
                        onClick={() => {
                          if (module.youtube) {
                            window.open(module.youtube, '_blank', 'noopener,noreferrer');
                          }
                        }}
