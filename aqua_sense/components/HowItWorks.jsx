...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Data streams securely to our cloud platform where it\'s processed, stored, and made available for real-time analysis.',
      step: '02',
      gradient: 'from-aqua-teal to-shakespeare-600',
    },
    {
      icon: Brain,
      title: 'ML Models & AI Agents',
      description: 'Advanced machine learning algorithms and AI agents analyze patterns, predict demand, and identify optimal reuse opportunities.',
      step: '03',
