                  ...
                  <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-5 py-4 rounded-xl bg-shakespeare-800/30 border-2 border-shakespeare-500/30 focus:border-shakespeare-400 text-shakespeare-100 outline-none transition-all"
                        required
                      >
