...
import { Brain, LineChart, AlertTriangle, Sparkles, Zap, Target } from 'lucide-react';
  ...
  const aiFeatures = [
    {
      ...
      description: 'ML models forecast water demand patterns up to 30 days in advance with 95% accuracy.',
      metrics: ['95% Accuracy', '30-day Forecast', 'Real-time Learning'],
          ...
          <div className="relative glassmorphism-strong p-16 border-2 border-shakespeare-600/30 shadow-2xl overflow-hidden animate-liquid-morph">
            ...
            <div className="relative text-center z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                {[
                  { value: '100K+', label: 'Data Points/Min', gradient: 'from-shakespeare-400 to-shakespeare-600' },
                  { value: '12', label: 'Active AI Agents', gradient: 'from-aqua-teal to-shakespeare-500' },
                  { value: '50ms', label: 'Response Time', gradient: 'from-orange-accent to-shakespeare-600' },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
